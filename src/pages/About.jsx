  ...
  return (
    <section className="max-container ">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>Fullstack Web Developer based in Indonesia, specializing in
        techincal education through hands-on learning and building
        applications.</p>
      </div>
      ...
      <div className="py-10 flex flex-col">
        ...
        <div className="mt-16 flex flex-wrap gap-12">
          {skills.map((skill) => (
            <div className="block-container w-20 h-20">
              ...
              <div className="btn-fron rounded-xl flex justify-center
              items-center">
                <img 
                  src={skill.imageUrl} 
                  alt={skill.name} 
        ...
        <div className="py-16">
          ...
          <div className="mt-5 flex flex-col gap-3 text-slate-500">
            <p> I've worked with all sorts companies, leveling up my
